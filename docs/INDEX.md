...
| **v8_ko(최신)** | [manuscript_v8_ko.md](../journal/manuscript_v8_ko.md) · [.docx](../journal/manuscript_v8_ko.docx) · [보충자료 S1](../journal/supplement_S1_v8_ko.md) | 학기 과제 수치 대조 일치 + 그림 2장(개념도·OLS 잔차)·표 1개(출원청별 유형 분포) 추가(그림 1–7, 표 1–9) + AI 문체·용어 재검토 |
