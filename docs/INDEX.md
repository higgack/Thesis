...
| **v10_ko(쉬운 판, 최신)** | [manuscript_v10_ko.md](../journal/manuscript_v10_ko.md) · [.docx](../journal/manuscript_v10_ko.docx) | v9를 60% 분량으로 축약한 단일 파일(부록 A–C 포함, 별도 보충자료 없음): 가설 3개(H1·H2·H3), 음이항 단일 표, 강건성 5항목, 참고문헌 44편; 숫자는 v9와 동일(자동 검증) |
