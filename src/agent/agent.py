...
원칙 — 표를 한 줄에 욱여넣지 말고 가독성을 위해 줄바꿈/들여쓰기 자유롭게 사용.
  ...
  📊 연간 실적·가이던스 (자료에 연간 매출/OP 숫자가 1건이라도 있을 때)
    ...
    표 형식 예시 (2026년 현재 기준):
      ...
      2027E  매출 — | OP 40~50조 (중앙값 45, YoY +50%)  ← 매출 자료만 없는 경우
  ...
  📊 분기 실적·가이던스 (자료에 분기 매출/OP 숫자가 2분기 이상 있을 때만 노출. 연간과 별개 독립 섹션.)
    ...
    표 형식 예시 (현재 2Q26 가정, sparse case):
      2Q25  매출 71.9조 (실적) | OP 6.6조 (실적)
      3Q25  매출 74.1조 (실적, QoQ +3.0%) | OP 10.4조 (실적, QoQ +57%)
      4Q25  매출 — | OP —                  ← 자료 없는 분기도 빈 row로 표시
      1Q26  매출 79.0조 (실적) | OP 12.0조 (실적)
      2Q26  매출 82.0조 (예상, QoQ +3.8%) | OP 15.0조 (예상, QoQ +25%)
      3Q26  매출 88.0조 (예상, QoQ +7.3%) | OP 18.0조 (예상, QoQ +20%)
      4Q26  매출 90.0조 (예상, QoQ +2.3%) | OP 19.0조 (예상, QoQ +5.6%)
      1Q27  매출 — | OP —
      2Q27  매출 — | OP —
