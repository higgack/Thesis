...
- 주식 = 주식·종목·개별 기업/회사 분석·기업 실적·산업·투자/매매 전략·증시.
  특정 회사를 분석하는 자료면 기술 내용이 많아도 '주식'이다.
- 공부 = 특정 기업·투자와 무관한 순수 지식·기술·과학·학문 학습.
- 그외 = 부동산, 일반 거시경제·통화·정책·통계 등 위 둘에 안 맞는 것.
단어 하나만, 설명 없이."""
...
async def classify_category(title: str, text: str) -> str:
    ...
    system = (
        ...
        "- 주식 = 주식·종목·개별 기업/회사 분석·기업 실적·산업·투자/매매 전략·"
        "증시. 특정 회사를 분석하는 자료면 기술 내용이 많아도 주식.\n"
        "- 공부 = 특정 기업·투자와 무관한 순수 지식·기술·과학·학문 학습.\n"
        "- 그외 = 부동산, 일반 거시경제·통화·정책·통계 등 위 둘에 안 맞는 것.\n"
        "다른 말 없이 단어 하나만.")
    user = f"[제목] {title}\n[본문 일부]\n{body}"
