...
*저널 투고용 원고 v2(국문). v1_ko에서 §3.2 생태계 절과 표 1을 삭제하고 부록 A·B를 본문에 편입하였다. 대상 저널: Technovation / Technological Forecasting and Social Change (Elsevier) 양식. 원고 유형: 연구논문. 분량: 본문 약 7,500단어 상당(참고문헌·표·부록 제외).*
...
![그림 1. 검색 전략](figures/figA1_search_strategy.png)
...
![그림 2](figures/fig4_applications_by_year.png)
...
![그림 3](figures/fig5_predicted_breadth.png)
...
![그림 5](figures/fig7_predicted_process_only.png)
...
특허 데이터는 EPO PATSTAT Global(2025년판)에서 라이선스 하에 추출되었으며 저자가 재배포할 수 없다. 추출 질의(CPC 코드와 키워드 필터, 표 1과 그림 1)와 추정 스크립트는 요청 시 저자로부터 제공받을 수 있다.
