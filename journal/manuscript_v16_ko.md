...
자료는 유럽특허청의 PATSTAT Global 2025년판에서 가져왔다(European Patent Office, 2025). 먼저 CPC 분류 H01L21(반도체 제조공정)과 H01L24(반도체 연결 기술)로 후보를 검색한 뒤, 제목에 하이브리드 본딩 관련 키워드(*hybrid bonding*, *direct bonding*, *Cu–Cu*, *copper to copper*, *metal-oxide bond*) 가운데 하나 이상이 들어 있는 출원만 남겼다(표 1). 그 결과 출원과 CPC 기호의 쌍 5,277건이 추출되었고, 출원 단위로 묶으면 1968–2024년에 출원된 928건이 된다. 따라서 표본은 하이브리드 본딩 특허 전체가 아니라 이 검색식으로 식별된 관련 출원이며, 제목에 관련어가 없는 출원은 포함되지 않는다. 추출 단계에서 두 클래스 밖의 기호는 보존되지 않았으므로, 모든 기호는 H01L21 계열(202개)과 H01L24 계열(60개)의 세부 분류(서브그룹) 262개로 이루어진다.
...
자료의 세 가지 특성을 미리 밝혀 둔다. 첫째, *hybrid bonding*은 비교적 정밀한 검색어이지만 *direct bonding*은 뜻이 넓다. 제목에 *hybrid bonding*이 들어 있는 출원은 467건이며, 이 핵심 표본으로 다시 추정한 결과를 제5.4절에 보고한다. 둘째, 키워드 필터는 직접 접합(direct bonding)이라는 말의 무관한 용법도 걸러내지 못한다. 세라믹 기판에 구리를 붙이는 DBC 기판, 구리 합금, 전력 모듈 등이 그 예다. 제목으로 식별한 이러한 출원은 68건이며, 이를 뺀 재추정 결과도 제5.4절에 보고한다(판정 기준과 분포는 부록 C). 셋째, 추출 자료에는 특허 패밀리 식별자가 없다. 같은 발명이 여러 나라에 출원되면 여러 건으로 잡힌다. 제목이 같은 출원을 하나로 보면 928건은 473개의 제목으로 이루어지며, 이 중 149개 제목은 둘 이상의 출원청에 출원되었다. 동일 제목은 정식 패밀리 식별자가 아니므로 이는 근사적 조정이며, 이 점이 결과에 미치는 영향도 제5.4절에서 확인한다.
...
표 3은 변수를 정의한다. 기술범위(breadth)는 출원에 부여된 H01L21·H01L24 계열의 서로 다른 서브그룹 기호의 수다. 이는 분류 기호의 수로 범위를 재는 Lerner(1994)의 방식을 두 클래스 안에 적용한 것으로, 두 클래스 안에서 특허가 걸치는 세부 기술의 다양성을 뜻하며 반도체 밖의 분야로 뻗는 정도나 법적 청구범위는 재지 않는다. 공동분류 유형(tech_cat)은 각 출원을 조립 단독형(H01L24 기호만), 통합형(둘 다), 공정 단독형(H01L21 기호만)으로 나누며, 통합형이 경계 넘기의 측정치다. 제조공정 분류 여부(has_process)는 H01L21 기호를 하나라도 가지면 1인 지표로, 통합형과 공정 단독형을 합한 것이다. 출원청(ccode)은 출원이 제출된 특허청 또는 출원 경로로 8개 수준이며 미국이 기준이다. 출원연도(yc)는 표본의 첫 출원(1968년)부터 지난 햇수다.

**표 3.** 변수 정의.

| 변수 | 정의 | 유형 |
|---|---|---|
| breadth | H01L21·H01L24 계열의 서로 다른 CPC 서브그룹 기호 수(클래스 내 기술범위) | 카운트, 1–21 |
| breadth_adj | breadth에서 각 클래스의 첫 기호를 뺀 값(제5.4절) | 카운트, 0–19 |
| tech_cat | 공동분류 유형: 조립 단독형(H01L24만) / 통합형(둘 다) / 공정 단독형(H01L21만) | 범주, 3 |
| has_process | H01L21 기호를 하나라도 가지면 1(제조공정 분류), 아니면 0 | 이항 |
| ccode | 출원청 또는 출원 경로: US(기준), CN, KR, TW, JP, EP, WO(PCT), 기타 | 범주, 8 |
| yc | 출원연도(1968년 = 0부터 지난 햇수); 표본 평균 49.7(2017.7년) | 정수, 0–56 |

기술범위는 평균 5.69개(표준편차 4.07, 범위 1–21)이며, 통합형 7.89개, 조립 단독형 4.16개, 공정 단독형 3.15개로 유형에 따라 다르다. 출원청별로는 미국 382건, 중국 175건, PCT 경로 113건, EPO 83건, 대만 75건, 한국 58건, 일본 26건, 기타 16건이다. 그림 2는 연도별 출원 건수다. 2010년 이전에는 드물다가 2010년대 후반에 급증하여 2022년경 정점에 이른다. 2023–2024년의 감소는 실제 감소가 아니라 출원 뒤 공개까지 걸리는 시차 때문이다. 유형별로는 통합형 425건(45.8%), 조립 단독형 338건(36.4%), 공정 단독형 165건(17.8%)이며, 제조공정 기호를 가진 출원은 590건(63.6%)이다.

![](figures/fig2_applications_by_year_ko.png)

**그림 2.** 출원연도별 하이브리드 본딩 관련 출원 건수, 1968–2024(N = 928). 2023–2024년의 감소는 공개 시차 때문이다.
...
| 기타 | 2.326 (0.681) | 2.021 (0.664) | 0.167 (2.128) | 2.631 (0.663) | 2.051 (0.680) | 0.000 (77776.491) | 2.979 (0.747) | 1.940 (0.684) |
...
| 일본(JP) | 0.086\*\*\* (0.816) | 0.087\*\*\* (0.817) | 0.061\*\* (1.222) | 0.103\*\*\* (0.833) | 0.015\*\*\* (1.466) | 0.000 (77497.743) | 0.061\*\*\* (0.836) | 3.240 (1.456) |
| EPO(EP) | 0.858 (0.438) | 0.868 (0.435) | 0.699 (0.764) | 0.956 (0.443) | 1.089 (0.494) | 0.000 (77240.682) | 0.804 (0.449) | 0.709 (0.578) |
| PCT(WO) | 1.997\*\* (0.323) | 2.016\*\* (0.322) | 1.636 (0.496) | 2.170\*\* (0.339) | 2.046\* (0.366) | 1.957 (0.530) | 2.167\*\* (0.385) | 1.694 (0.364) |
| 기타 | 1.901 (0.779) | 1.923 (0.775) | 1.847 (1.010) | 2.385 (0.758) | 0.996 (0.914) | 0.000 (77776.491) | 2.172 (0.837) | — |
| N | 928 | 928 | 473 | 908 | 860 | 467 | 753 | 830 |
| 로그우도 | −774.5 | −829.4 | −425.3 | −755.9 | −682.7 | −364.0 | −607.4 | −683.0 |
...
**무관 대안의 독립성(IIA).** 다항 로짓의 IIA 가정을 간접 점검하기 위해 공정 단독형을 제외한 표본(N = 763)에서 통합형 대 조립 단독형을 이항 로짓으로 추정하면 기술범위 OR 1.463, 출원연도 0.987, 중국 출원청 1.177로, 다항 로짓 통합형 방정식의 값(1.403, 0.993, 1.205)과 거의 같다. 세 번째 대안의 존재가 통합형 방정식의 추정을 왜곡한다는 징후는 없다.
