...
**출원청.** 어디에 출원하는가는 누가 무엇을 위해 발명하는가를 반영한다. 단계별 추격의 논리(Lee and Lim, 2001), 중국 특허에 관한 증거(Hu and Jefferson, 2009; Dang and Motohashi, 2015), 반도체 가치사슬에서 중국의 위치(Grimes and Du, 2022)를 함께 보면, 중국 출원청 출원은 특정 제조 단계의 확보에 집중되어 범위가 좁고 공정 단독형이 많을 것으로 예상된다. 이 예상에는 중간 논리가 필요하다. 중국 특허의 증가, 보조금, 추격이라는 사실 자체가 곧바로 좁은 CPC 범위와 공정 단독형을 예측하지는 않기 때문이다. 후발국의 특허 활동이 생산 역량의 국산화, 공정별 병목의 해소, 특정 제조 단계의 권리 확보에 집중될 경우, 하나의 출원이 포괄하는 기술 요소는 시스템 전체의 통합보다 개별 공정 문제의 해결에 가까울 수 있다. 이 경우 두 클래스 안의 CPC 범위는 좁고 공정 단독형의 비중은 높을 것으로 예상된다. 이 예상은 중국 특허 선행연구의 직접적인 결론이 아니라, 단계별 추격의 논리를 본 연구의 특허 구성에 적용해 도출한 것이다. 두 예상은 서로 다른 모형으로 검정되므로 나누어 세운다.
